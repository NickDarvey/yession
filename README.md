...
- **Metro/Zune styling (delivered):** [docs/plans/02-metro-zune-styling.md](docs/plans/02-metro-zune-styling.md)
- **Rich-text editing (ProseMirror bodies on a Yjs XmlFragment, delivered):** [docs/plans/03-rich-text-editing.md](docs/plans/03-rich-text-editing.md)
- **Collaborative presence cursors (title + bodies, delivered):** [docs/plans/05-presence-cursors.md](docs/plans/05-presence-cursors.md)
- **Telemetry (OpenTelemetry — Manager as collector, sessions emit, delivered):** [docs/plans/04-telemetry.md](docs/plans/04-telemetry.md)
