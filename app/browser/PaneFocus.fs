module Yession.Browser.PaneFocus

// Focus moves the model cannot make (Plan 14, stage 2).
//
...
//
// Its own module because two entry points need the same two moves — the app (`Browser.fs`)
// and the host-free shell harness the `Browser`-tier E2E drives. A second copy would be a
