...
module Dom =
    ...
    module Text =
        ...
        /// the send because that is what every chat surface's Enter is; the new line moved
        /// to Alt+Enter rather than disappearing.
        let composerKeys = "Enter sends · Alt+Enter for a new line"
